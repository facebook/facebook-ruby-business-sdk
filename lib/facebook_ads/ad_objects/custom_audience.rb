...
module FacebookAds
  ...
  class CustomAudience < AdObject
    ...
    has_edge :capabilities do |edge|
      ...
      edge.get 'CustomAudienceCapabilities'
      edge.post do |api|
    ...
    has_edge :shared_account_campaign_info do |edge|
      edge.get 'CustomAudienceSharedAccountCampaignInfo'
    end
    ...
    has_edge :usage_history do |edge|
      edge.get 'CustomAudienceUsageHistory'
    end
