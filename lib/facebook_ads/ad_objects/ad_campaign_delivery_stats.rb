...
module FacebookAds
  ...
  class AdCampaignDeliveryStats < AdObject
    BID_RECOMMENDATION_TIME_RANGE_TYPE = [
      "SINCE_LAST_LEARNING_STAGE_EXIT",
      "LAST_N_DAYS",
      "SINCE_LAST_SIGNIFICANT_EDIT",
    ]


    field :bid_recommendation, 'double'
    field :current_average_cost, 'double'
    field :delivery_warning, { list: 'string' }
    field :has_unrealistic_high_bid, 'bool'
