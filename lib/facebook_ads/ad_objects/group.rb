...
module FacebookAds
  ...
  class Group < AdObject
    ...
    has_edge :access_requests do |edge|
      edge.get
    end
    ...
    has_edge :former_members do |edge|
      edge.get 'User'
    end
    ...
    has_edge :guest_members do |edge|
      edge.get 'User'
    end
    ...
    has_edge :member_requests do |edge|
      edge.get 'User'
    end
    ...
    has_edge :members do |edge|
      ...
      edge.get 'User' do |api|
        api.has_param :member_ids, { list: 'int' }
      end
      edge.post 'Group' do |api|
        api.has_param :member, 'int'
        api.has_param :email, 'string'
    ...
    has_edge :pixel_insights do |edge|
      edge.get do |api|
        api.has_param :ads_pixels, { list: 'object' }
        api.has_param :event_names, { list: 'string' }
        api.has_param :start_date, 'string'
        api.has_param :end_date, 'string'
      end
    end

    has_edge :reported_content do |edge|
      edge.get
    end
