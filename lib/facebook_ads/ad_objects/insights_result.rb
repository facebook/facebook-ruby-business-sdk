...
module FacebookAds
  ...
  class InsightsResult < AdObject
    ...
    METRIC = [
      ...
      "fb_media_matching_copyright_comment_count",
      "fb_media_matching_copyright_daily_comment_count",
      "fb_media_matching_copyright_daily_like_count",
      "fb_media_matching_copyright_daily_post_impressions",
      "fb_media_matching_copyright_daily_post_impressions_by_age_bucket_and_gender",
