...
module FacebookAds
  ...
  class Page < AdObject
    ...
    has_edge :audio_releases do |edge|
      edge.get 'AudioRelease' do |api|
        api.has_param :filtering, { list: 'object' }
      end
    end

    has_edge :bc_sponsored_posts do |edge|
      edge.get 'EntWithSponsor'
    end
    ...
    has_edge :budget_recs do |edge|
      edge.get 'PageBudgetRecs' do |api|
        api.has_param :custom_budget, 'int'
        api.has_param :max_budgets_count, 'int'
        api.has_param :ad_account, 'string'
        api.has_param :campaign_length, 'int'
      end
    end
    ...
    has_edge :checkin_posts do |edge|
      edge.get 'PagePost'
    end
    ...
    has_edge :commerce_orders do |edge|
      edge.get 'CommerceOrder' do |api|
        api.has_param :status, { list: { enum: -> { CommerceOrder::STATUS }} }
        api.has_param :updated_after, 'object'
      end
    end

    has_edge :component_flow do |edge|
      edge.get 'PagesPlatformComponentFlow'
    end
    ...
    has_edge :content_tests do |edge|
    ...
    has_edge :copyright_matches do |edge|
      edge.get 'VideoCopyrightMatch' do |api|
        api.has_param :match_status, { enum: -> { VideoCopyrightMatch::MATCH_STATUS }}
        api.has_param :video_id, 'int'
      end
    end

    has_edge :copyright_reference_matches do |edge|
      edge.get 'VideoReferenceMatch' do |api|
        api.has_param :status_group, { enum: -> { VideoReferenceMatch::STATUS_GROUP }}
      end
    end
    ...
    has_edge :document_fonts do |edge|
      edge.get 'DocumentFont'
    end
    ...
    has_edge :draft_posts do |edge|
      edge.get 'DraftPost'
    end

    has_edge :editions do |edge|
      edge.get 'TarotDigest' do |api|
        api.has_param :publish_statuses, { list: { enum: -> { TarotDigest::PUBLISH_STATUSES }} }
      end
    end

    has_edge :es_video_reference_matches do |edge|
      edge.get 'VideoReferenceMatch' do |api|
        api.has_param :status_group, { enum: -> { VideoReferenceMatch::STATUS_GROUP }}
      end
    end
    ...
    has_edge :feature_access_list do |edge|
      edge.get 'PageFeatureAccessList'
    end
    ...
    has_edge :indexed_by_universal_id_videos do |edge|
      edge.get 'AdVideo'
    end

    has_edge :indexed_video_copyright_matches do |edge|
      edge.get 'VideoCopyrightMatch' do |api|
        api.has_param :match_status, { enum: -> { VideoCopyrightMatch::MATCH_STATUS }}
      end
    end
    ...
    has_edge :instant_article_ctas do |edge|
      edge.get 'InstantArticleCta'
    end

    has_edge :instant_article_styles do |edge|
      edge.get
    end
    ...
    has_edge :instant_articles_cms_search do |edge|
      edge.get 'InstantArticle'
    end

    has_edge :instant_articles_dev_feed do |edge|
      edge.get 'InstantArticle'
    end
    ...
    has_edge :instant_articles_sample_feed do |edge|
      edge.get 'InstantArticle'
    end

    has_edge :instant_articles_traffic_lift do |edge|
      edge.get 'InstantArticleTrafficLift'
    end

    has_edge :jobs do |edge|
      edge.get 'JobOpening'
    end
    ...
    has_edge :lent_video_assets do |edge|
      edge.get 'VideoAsset'
    end
    ...
    has_edge :locations_breakdown_search do |edge|
      edge.get 'PageLocationsBreakdown' do |api|
        api.has_param :q, 'string'
      end
    end

    has_edge :marketing_areas do |edge|
      edge.get 'MarketingArea'
    end

    has_edge :media_copyright_attributions do |edge|
      edge.get 'MediaCopyrightAttribution' do |api|
        api.has_param :filtering, { list: 'object' }
      end
    end
    ...
    has_edge :news_subscriptions do |edge|
      edge.get 'StonehengeSubscriptionPublisher'
    end
    ...
    has_edge :page_app_with_leads_access do |edge|
      edge.get 'PageAppWithLeadsAccess'
    end
    ...
    has_edge :page_direct_integration_crm_with_leads_access do |edge|
      edge.get 'PageDirectIntegrationCrmWithLeadsAccess'
    end

    has_edge :page_partner_with_leads_access do |edge|
      edge.get 'PagePartnerWithLeadsAccess'
    end

    has_edge :page_user_with_leads_access do |edge|
      edge.get 'PageUserWithLeadsAccess' do |api|
        api.has_param :business_id, 'string'
      end
    end
    ...
    has_edge :posts_insights do |edge|
      edge.get 'InsightsResult' do |api|
        api.has_param :since, 'datetime'
        api.has_param :until, 'datetime'
        api.has_param :metrics, { list: 'object' }
        api.has_param :offset, 'int'
        api.has_param :active_post, 'bool'
        api.has_param :sort_metric, 'string'
        api.has_param :sort_dir, { enum: -> { InsightsResult::SORT_DIR }}
      end
    end
    ...
    has_edge :reviewable_bc_posts do |edge|
      edge.get 'EntWithSponsor'
    end

    has_edge :reviewable_bc_posts_creator do |edge|
      edge.get 'EntWithSponsor'
    end
    ...
    has_edge :scheduled_posts_internal do |edge|
      edge.get 'ScheduledPost'
    end
    ...
    has_edge :search_dialogs do |edge|
      edge.get 'SearchDialogData'
    end
    ...
    has_edge :shared_location_structures do |edge|
      edge.get 'Page'
    end
    ...
    has_edge :similar_places do |edge|
      edge.get 'Page' do |api|
        api.has_param :limit, 'int'
      end
    end

    has_edge :store_visits_custom_audiences_eligible_countries do |edge|
      edge.get 'PageStoreVisitsCustomAudiencesEligibleCountries'
    end

    has_edge :store_visits_demographic_insights_by_country do |edge|
      edge.get 'PageStoreVisitsDemographicInsights' do |api|
        api.has_param :breakdowns, { list: { enum: -> { PageStoreVisitsDemographicInsights::BREAKDOWNS }} }
        api.has_param :since, 'object'
        api.has_param :until, 'object'
    ...
    has_edge :store_visits_demographic_insights_by_location_page_id do |edge|
      edge.get 'PageStoreVisitsDemographicInsights' do |api|
        api.has_param :breakdowns, { list: { enum: -> { PageStoreVisitsDemographicInsights::BREAKDOWNS }} }
        api.has_param :since, 'object'
        api.has_param :until, 'object'
    ...
    has_edge :store_visits_demographic_insights_by_partner_location_id do |edge|
      edge.get 'PageStoreVisitsDemographicInsights' do |api|
        api.has_param :breakdowns, { list: { enum: -> { PageStoreVisitsDemographicInsights::BREAKDOWNS }} }
        api.has_param :since, 'object'
        api.has_param :until, 'object'
        api.has_param :partner_location_id, 'string'
      end
    end
    ...
    has_edge :venue_events do |edge|
      edge.get 'Event'
    end

    has_edge :video_assets do |edge|
      edge.get 'GenericVideoAsset'
    end
    ...
    has_edge :video_copyright_matches do |edge|
      edge.get 'VideoCopyrightMatch' do |api|
        api.has_param :match_status, { enum: -> { VideoCopyrightMatch::MATCH_STATUS }}
        api.has_param :video_id, 'int'
      end
    ...
    has_edge :video_reference_matches do |edge|
      edge.get 'VideoReferenceMatch' do |api|
        api.has_param :status_group, { enum: -> { VideoReferenceMatch::STATUS_GROUP }}
      end
    end
